...
from trm.nn import Block, CosSin, Embedding, Linear, RotaryEmbedding, Transformer
...
class Model(eqx.Module):
    ...
    def __call__(
        ...
        *,
        ...
        x_embed = self.embed_inputs(batch["inputs"], task_emb)
    ...
    def embed_inputs(
        ...
        task = task_emb.astype(self.forward_dtype)
        if task.ndim == 2:
            task = task[:, None, :]
